$(document).ready(function(){
 ...
 // Initialize Firebase
  var config = {
    apiKey: "AIzaSyAT6G2aoOmxImizq_n-aSFmmXBwC5E05_w",
    authDomain: "train-app-357.firebaseapp.com",
    databaseURL: "https://train-app-357.firebaseio.com",
    projectId: "train-app-357",
    storageBucket: "",
    messagingSenderId: "279106465739"
  };
...
$('#addTrainBtn').on("click", function() {
  ...
  var newTrain = {
      ...
      freq: frequency
        ...
        $("#trainNameInput").html(trainName);
        $("#destinationInput").html(destination);
        $("#timeInput").html(firstTrain);
        $("#frequencyInput").html(frequency);
